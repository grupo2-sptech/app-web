...
update historico_hardware set ram_ocupada = 7583645696, cpu_ocupada = 3.6 where fk_maquina = '502';
...
update historico_hardware set ram_ocupada = 7610138624, cpu_ocupada = 5.2 where fk_maquina = '501';
...
funcionario as f on fk_funcionario = funcionario_id  where fk_maquina = 501;
...
select ROUND(h.ram_ocupada / (1024 * 1024 * 1024), 2) as ram_ocupada_gb, h.cpu_ocupada from historico_hardware as h where hardware_historico_id = 508;
